...
public abstract class Global {
    ...
    public static int originalHeight = 500;                            //Height at which the screen was drawn at the start
    public static int originalWidth = 500;                             //Width at which the screen was drawn at the start
