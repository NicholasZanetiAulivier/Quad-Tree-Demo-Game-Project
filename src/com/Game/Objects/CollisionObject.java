...
public interface CollisionObject {
    ...
    static final short ENEMY_BIG_BOSS = 2010;
    static final short ENEMY_SUMMONER_BOSS = 2011;
    static final short ENEMY_DASHER_BOSS = 2012;
    static final short ENEMY_SHOOTER_BOSS = 2013;
